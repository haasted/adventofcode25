...
func Test3(t *testing.T) {
	var mj int
	mj = newBank("987654321111111").findMaxJoltage()
	assert(mj == 98)
	mj = newBank("811111111111119").findMaxJoltage()
	assert(mj == 89)
	mj = newBank("234234234234278").findMaxJoltage()
	assert(mj == 78)
	mj = newBank("818181911112111").findMaxJoltage()
	assert(mj == 92)
}
